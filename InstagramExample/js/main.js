    ...
    $.ajax({
        ...
        success: function(response) {
            $.each(response.data,function(index,value){
                if(value.type == "image"){
                    $('#resultDiv').append('<div class=\'results card medium\'><img width=\''+value.images.low_resolution.width+'\' src=\''+value.images.low_resolution.url+'\' class=\'materialboxed\'></div>');
                }else{
